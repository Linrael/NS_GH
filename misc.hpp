...
void write_parameters(std::string fileName, std::vector<double> U, std::vector<double> V, std::vector<double> P,
                      std::vector<unsigned char> FLAG, int imax, int jmax, double xlength, double ylength, double delt);
